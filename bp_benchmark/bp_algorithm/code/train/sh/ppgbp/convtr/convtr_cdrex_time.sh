...
# do
# for C21 in 1e-1 1e-3 1e-5
# do
# for C22 in 1e-1 1e-3 1e-5
# do
# CUDA_VISIBLE_DEVICES=5 python train.py --config ./core/config/dl/convtr/convtr_ppgbp.yaml \
...
do
for sbp_beta in 5e-1 1e-1 5e-2 1e-2 5e-3
do
for dbp_beta in 5e-1 1e-1 5e-2 1e-2 5e-3
do
for C1 in 5e-4 1e-4 5e-5 1e-5
do
for C21 in 1e-2 5e-3 1e-3 5e-4 1e-4
do
for C22 in 5e-4 1e-4 5e-5 1e-5
do
CUDA_VISIBLE_DEVICES=5 python train.py --config ./core/config/dl/convtr/convtr_ppgbp.yaml \
--num_filters 12 --num_heads 4 --d_model 96 --dropout 0.1 --num_layer 4 \
--lr 1e-3 --wd ${wd} --max_epochs 100 --method cdrex_time \
